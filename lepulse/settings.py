...
MIDDLEWARE = [
    ...
    *(['whitenoise.middleware.WhiteNoiseMiddleware'] if env_bool('DJANGO_SERVE_FILES', not DEBUG) else []),
...
# Nginx termine TLS et transmet le protocole public avec X-Forwarded-Proto.
